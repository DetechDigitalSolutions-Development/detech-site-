            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    @foreach ($recentProjects as $project)
                        <!-- Option 1: Single swiper-slide wrapper -->
                        {{-- <div class="swiper-slide">
                            @include('components.cards.projects_card', ['project' => $project])
                        </div> --}}

                        <!-- Option 2: Pass swiperSlideClass as a parameter to your component -->
                        @include('components.cards.projects_card', [
                            'project' => $project,
                    ...
                    <div class="swiper-slide">
                        <a href="{{ route('projects') }}"
                            class="button button--primary heading text-50 rotate-90-center"

                ...
                <div class="swiper-wrapper">
                    @foreach ($testimonials as $testimonial)
                        <div class="swiper-slide">
                            <div class="card-testimonial radius18 equal-height-card" data-aos="fade-up" data-aos-delay="10">
                                <div class="card-content">
                                    ...
                                    <p class="text text-24 testimonial-text">
                                        “ {{ $testimonial->comments }} ”
                                    </p>
                                    <div class="user-info-wrap">
                                        <div class="user-info">
                                            <div class="user-img">
                                                <img src="{{ Storage::disk(config('public'))->url($testimonial->profile_img) }}"
                                                    width="80" height="80" loading="lazy" alt="image">
                                            </div>
                                        ...
                                        <div class="icon-quote">
                                            <svg class="icon icon-62" width="62" height="62"

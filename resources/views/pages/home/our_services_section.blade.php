      ...
      <div class="section-headings-left">
        <div class="subheading text-20 subheading-bg" data-aos="fade-right" data-aos-delay="10">
          <svg class="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            ...
            <defs>
              <clipPath><rect width="14" height="14" fill="CurrentColor"/></clipPath>
            </defs>
          </svg>
        ...
        <ul class="service-list list-unstyled radius18">
          ...
          <li class="accordion-li">
            <div class="accordion-title">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="icon icon-plus-circle">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
              </svg>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="icon icon-minus-circle">
            ...
            <div class="accordion-content">
              <div class="service-content-inner">
                ...
                <div class="service-button">
                  <a href="{{ route('services.show', $service['id']) }}" class="button button--primary">+ View Details</a>
                </div>
              </div>
            </div>
          </li>

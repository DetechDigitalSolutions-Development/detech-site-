                    ...
                    <div class="row">
                        <div class="col-lg-7 col-12">
                            <div class="content-details-inner">
                                <h2 class="heading text-50" data-aos="fade-up">{{ $project->title }}</h2>
                                <p class="text text-18" data-aos="fade-up">{!! $project->content_section_1 !!}</p>
                                ...
                                <p class="text text-18" data-aos="fade-up">{!! $project->content_section_2 !!}</p>
                                ...
                                <div class="sidebar-widget project-info radius18" data-aos="fade-up">
                                   ...
                                   <ul class="project-info-list list-unstyled">
                                        ...
                                        <li class="project-info-item">
                                            ...
                                            <div class="info-data text text-16">{{ implode(', ', $project->categories) }}</div>
                                        </li>
                                        <li class="project-info-item">
                                            <div class="info-title heading text-18">Website:</div>
                                            <a href="{{ $project->website }}" class="info-data text text-16">{{ str_replace(['http://', 'https://'], '', $project->website) }}</a>
                                        </li>
                                   </ul>
                                </div>
                                <div

            ...
            <div class="row product-grid">
                @foreach ($services as $index => $service)
                    <div class="col-xl-4 col-md-6 col-12" data-aos="fade-up"
                        ...
                        <a class="multicolumn-card" href="{{ route('services.show', $service['id']) }}"
                            ...
                            <div class="card-icon">
                                ...
                                @if ($icon_path && file_exists(public_path($icon_path)))
                                    <img src="{{ asset($icon_path) }}" alt="Service Icon" class="service-icon-small">
                                @else
                                    <!-- Fallback icon -->
                            ...
                            <!-- Service Title -->
                            <h2 class="heading text-28 mt-4">{{ $service['title'] }}</h2>

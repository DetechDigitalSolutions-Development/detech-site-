...
@section('content')
    <main>
        @include('components.page_banner', [
            'title' => 'Our Services',
            'title_route' => 'services.index',
            'sub_title' => $service['title'],
            'banner_image' => $service['image'] ?? null,
        ])
        ...
        <div class="page-service-details mt-100">
            <div class="container">
                ...
                <drawer-opener class="open-sidebar svg-wrapper text text-20 fw-500 d-lg-none"
                    data-drawer=".drawer-service-sidebar" data-aos="fade-up">
                            ...
                            <aside class="service-sidebar">
                                                    ...
                                                    @foreach ($serv['subservices'] as $index => $subservice)
                                                        <li>
                                                            <a class="secvice-category subheading subheading-bg subservice-link text-18 fw-400 {{ $index === 0 ? 'active' : '' }}"
                                                                href="#" data-subservice="{{ $subservice['id'] }}">
                                                                {{ $subservice['title'] }}
                                ...
                                <div class="sidebar-widget service-contact radius18" data-aos="fade-up">
                                    <div class="media media-bg overlay">
                                        <img src="{{ asset('assets/img/service/service-contact.png') }}" width="1000"
                                            height="929" loading="lazy" alt="Contact us">
                                    </div>
                                    <div class="service-contact-content">
                                        ...
                                        <a class="contact-number heading text-24"
                                            href="tel:{{ setting('company_tel_no', $default = null) }}">{{ setting('company_tel_no', $default = null) }}</a>
                                    </div>
                                </div>
                                ...
                                <div class="sidebar-widget radius18" data-aos="fade-up">
                                    <div class="service-download">
                                        ...
                                        <div class="service-download">
                                            <svg class="icon-50" width="50" height="50" viewBox="0 0 50 50"
                                                fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="service-details-content" id="service-content">
                            @if (isset($service['active_subservice']))
                                ...
                                <div class="details-media radius18" data-aos="fade-up">
                                    <img src="{{ asset($service['active_subservice']['image']) }}" width="1000"
                                        height="596" loading="lazy" alt="{{ $service['active_subservice']['title'] }}">
                                </div>

                                <!-- Service Title -->
                                <h2 class="heading text-50" data-aos="fade-up">{{ $service['active_subservice']['title'] }}
                                </h2>

                                <!-- Service Description -->
                                <p class="text text-18" data-aos="fade-up">
                                    {{ $service['active_subservice']['description'] }}</p>
                                    ...
                                    <div class="row service-row">
                                        <div class="col-xl-6 col-lg-12 col-md-6 col-12">
                                            <div class="choose-us-img radius18">
                                                <img src="{{ asset($service['active_subservice']['why_choose']['image']) }}"
                                                    width="1000" height="962" loading="lazy" alt="Why Choose Us">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-12 col-md-6 col-12">
                                            <div class="choose-us-desc">
                                                ...
                                                <p class="text text-18">
                                                    {{ $service['active_subservice']['why_choose']['description'] }}</p>
                                ...
                                <p class="text text-18" data-aos="fade-up">
                                    {{ $service['active_subservice']['additional_description'] }}</p>
                                    ...
                                    @foreach ($service['active_subservice']['faqs'] as $faq)
                                        <div class="accordion-block" data-aos="fade-up">
                                            ...
                                            <div class="accordion-content">
                                                <div class="accordion-content-inner text text-18">{{ $faq['answer'] }}
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach

                        ...
                        <faq-accordion>
                            <div class="accordion-list">
                                <div class="accordion-block" data-aos="fade-up">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Detech provides end-to-end technology solutions including web and mobile app
                                            development, full-stack software solutions, cloud integration, AI-powered
                                            applications, and IT consulting. We also specialize in delivering tailored
                                            enterprise solutions to help businesses thrive in a digital-first world.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="50">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            We prioritize data security at every stage of development. From encryption and
                                            secure coding practices to compliance with international standards, Detech
                                            ensures your data remains protected, private, and resilient against threats.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Yes. Our team has the expertise and resources to handle projects of any
                                            scale—from startups seeking rapid growth to enterprises requiring complex,
                                ...
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="150">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Absolutely. Detech integrates cutting-edge AI and machine learning technologies
                                            to help businesses automate processes, gain insights, and enhance customer
                                            experiences.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Our team consists of skilled professionals with experience across full-stack
                                            development, cloud computing, AI, and enterprise systems. With 16+ completed
                                            projects and 30+ satisfied clients, we bring proven expertise to every
                                            engagement.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="250">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Yes. In addition to software development, Detech provides digital marketing and
                                            SEO services to help businesses strengthen their online presence, generate
                                            leads, and grow their brand visibility.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="300">
                                    <div class="accordion-opener heading text-22">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Yes. Our solutions are scalable and customizable, allowing us to serve both
                                            niche businesses and large enterprises across multiple industries.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="350">
                                    <div class="accordion-opener heading text-22">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            We help startups, SMEs, and global enterprises that want to leverage technology
                                            for growth, efficiency, and innovation.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-block" data-aos="fade-up" data-aos-delay="400">
                                    <div class="accordion-opener heading text-22">
                                    ...
                                    <div class="accordion-content">
                                        <div class="accordion-content-inner text text-18">
                                            Our clients range from local startups to global enterprises across industries
                                            such as finance, insurance, logistics, healthcare, and technology. We focus on
                                            building long-term partnerships by delivering measurable business value.
                                        </div>
                                    </div>
                                </div>
                            </div>

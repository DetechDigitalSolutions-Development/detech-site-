...
@section('content')
    <main>
      <!-- Page Banner -->
      @include('components.page_banner',['title'=>'Contact Us','banner_image'=>'assets/img/banner/page-banner.png'])
              ...
              <div class="col-12 col-lg-6 col-contact-content">
                <div class="section-headings">
                  ...
                  <p class="text text-18" data-aos="fade-up">
                    Reach out through your preferred method of contact our team is ready to connect, collaborate, and show you how Detech’s technology solutions can drive your success.
                  </p>
                  ...
                  <div class="card-icon-text card-icon-text-horizontal">
                    ...
                    <div class="content">
                      ...
                      <p class="text text-16" data-aos="fade-up">
                        Delivering innovative solutions across industries from banking and insurance to wealth management and digital security.
                      </p>
                    </div>
                  </div>
                  <div class="card-icon-text card-icon-text-horizontal">
                    ...
                    <div class="content">
                      ...
                      <p class="text text-16" data-aos="fade-up">
                        Trusted by startups, enterprises, and global businesses to turn vision into innovation and measurable growth.
                      </p>
                    </div>
                  </div>
                </div>
              </div>
              @include('pages.contact.contact_form')
            </div>
          </div>
        </div>
      </div>

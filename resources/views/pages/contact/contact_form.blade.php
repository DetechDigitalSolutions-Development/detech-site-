<div class="col-12 col-lg-6 col-contact-form" data-aos="fade-up">
    <div class="contact-form-wrap radius18">
        ...
        @if (session('success'))
            <div class="subheading text-10 subheading-bg" role="alert" data-aos="fade-up"
        ...
        <form action="{{ route('appointments.store') }}" method="POST" class="form contact-form " data-aos="fade-up">
            ...
            <div class="field">
                ...
                <input id="ContactForm-email" class="text text-16" type="text" placeholder="Email Here *"
                    name="email" required>
            </div>
            <div class="field">
                ...
                <input id="ContactForm-service" class="text text-16" type="text" placeholder="Service Type *"
            ...
            <div class="field">
                ...
                <textarea id="ContactForm-body" class="text text-16" rows="4" placeholder="Your Comment *" name="message"
                    required></textarea>
            </div>

...
<main>
      <!-- Page Banner -->
      @include('components.page_banner',['title'=>'Our Products','banner_image'=>'assets/img/banner/OurProduct_top.png'])
            ...
            <nav class="pagination">
              ...
              >
                ...
                <li class="{{ $products->onFirstPage() ? 'disabled' : '' }}">
                  <a
                    @if ($products->previousPageUrl()) href="{{ $products->previousPageUrl() }}" @else role="link" aria-disabled="true" @endif
                ...
                <li class="{{ $products->hasMorePages() ? '' : 'disabled' }}">
                  <a
                    @if ($products->nextPageUrl()) href="{{ $products->nextPageUrl() }}" @else role="link" aria-disabled="true" @endif
                    class="pagination-link"

        ...
        <div class="page-project-details mt-100">
            <div class="container">
                <div class="project-media radius18" data-aos="fade-up">
                    <img src="{{ Storage::disk(config('public'))->url($product->featured_img) }}" width="1400" height="637" loading="lazy" alt="Image">
                </div>
            </div>
            <div class="container">
                                    ...
                                    <div class="row product-grid">
                                        <div class="col-md-6 col-12">
                                            <div class="project-img radius18" data-aos="fade-up">
                                                <img src="{{ Storage::disk(config('public'))->url($product->product_imgs[0]) }}" width="800" height="791" loading="lazy" alt="Image">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="project-img radius18" data-aos="fade-up" data-aos-delay="100">
                                                <img src="{{ Storage::disk(config('public'))->url($product->product_imgs[1]) }}" width="800" height="791" loading="lazy" alt="Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sidebar-widget project-info radius18" data-aos="fade-up">
                                   ...
                                   <ul class="project-info-list list-unstyled">
                                        ...
                                        <li class="project-info-item">
                                            ...
                                            <div class="info-data text text-16">{{ implode(', ', $product->categories) }}</div>
                                        </li>
                                        <li class="project-info-item">
                                            <div class="info-title heading text-18">Website:</div>
                                            <a href="{{ $product->website }}" class="info-data text text-16">{{ str_replace(['http://', 'https://'], '', $product->website) }}</a>
                                        </li>
                                   </ul>
                                </div>
                                <div

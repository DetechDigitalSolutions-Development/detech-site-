                    ...
                    <div class="">
                        <div class="section-headings">
                            ...
                            <h2 class="heading text-50" data-aos="fade-up" data-aos-delay="50">
                                ...
                                <div class=" text-20 subheading" data-aos="fade-up" data-aos-delay="50">
                                    {{-- {{ $career->job_title }} --}}
                                </div>
                            </h2>
                            ...
                            <div class="faq-form-wrap radius18" data-aos="fade-up">
                                <form action="{{ route('careers.apply.submit', $career->id) }}" method="POST"
                                    class="faq-form form contact-form" enctype="multipart/form-data">
                                    @csrf

                                    <!-- Add debug messages at the top -->
                                    @if ($errors->any())

...
<main>
    <!-- Page Banner -->
    @include('components.page_banner',['title'=>'Blogs Details','banner_image'=>'assets/img/banner/page-banner.png'])
    ...
    <div class="page-blog-details mt-100">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="blog-details">
                        <div class="card-blog-list" data-aos="fade-up">
                            <div class="card-blog-list-media radius18">
                                <img src="{{ Storage::disk(config('public'))->url($blog->featured_img ?? null) }}" alt="blog image" width="1000" height="707" loading="lazy">
                            </div>
                ...
                @include('pages.blogs.sidebar_section',['blog'=>$blog],['latestBlogs'=>$latestBlogs])
            </div>
        </div>
    </div>
</main>

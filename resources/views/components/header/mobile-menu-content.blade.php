<div class="drawer-block">
    ...
    <ul class="drawer-additional-menu list-unstyled flex-direction-column">
        <li class="nav-item"><a class="menu-link" href="services.html">Launch with Consulo</a></li>
        <li class="nav-item"><a class="menu-link" href="project.html">Migrate to Consulo</a></li>
        <li class="nav-item"><a class="menu-link" href="contact.html">Partner Services</a></li>
        <li class="nav-item"><a class="menu-link" href="project-details.html">Professional Services</a></li>
    </ul>
</div>

                        ...
                        <div class="card-pricing radius18 {{ $plan->is_highlighted ? 'active' : '' }}">
                            <div class="card-pricing-headings radius18" data-aos="fade-up">
                                ...
                                <div class="pricing-box">
                                    ...
                                    <span class="subheading subheading-monthly text-16 fw-400">{{ $plan->billing_period }}</span>
                            ...
                            <ul class="text-lists list-unstyled">
                                @if($plan->features)
                                    ...
                                    <li class="text-item text text-18" data-aos="fade-up" data-aos-delay="{{ ($loop->index + 1) * 50 }}">
